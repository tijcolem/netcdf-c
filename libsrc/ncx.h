...
extern int ncx_get_int64(const void **xpp, long long *llp);
extern int ncx_getn_double_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_getn_float_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_getn_int_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_getn_longlong_double(const void **xpp, size_t nelems, double* tp);
extern int ncx_getn_longlong_float(const void **xpp, size_t nelems, float* tp);
extern int ncx_getn_longlong_int(const void **xpp, size_t nelems, int* tp);
extern int ncx_getn_longlong_longlong(const void **xpp, size_t nelems, longlong* tp);
extern int ncx_getn_longlong_schar(const void **xpp, size_t nelems, schar* tp);
extern int ncx_getn_longlong_short(const void **xpp, size_t nelems, short* tp);
extern int ncx_getn_longlong_uchar(const void **xpp, size_t nelems, uchar* tp);
extern int ncx_getn_longlong_uint(const void **xpp, size_t nelems, uint* tp);
extern int ncx_getn_longlong_ulonglong(const void **xpp, size_t nelems, ulonglong* tp);
extern int ncx_getn_longlong_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_getn_uint_double(const void **xpp, size_t nelems, double* tp);
extern int ncx_getn_uint_float(const void **xpp, size_t nelems, float* tp);
extern int ncx_getn_uint_int(const void **xpp, size_t nelems, int* tp);
extern int ncx_getn_uint_longlong(const void **xpp, size_t nelems, longlong* tp);
extern int ncx_getn_uint_schar(const void **xpp, size_t nelems, schar* tp);
extern int ncx_getn_uint_short(const void **xpp, size_t nelems, short* tp);
extern int ncx_getn_uint_uchar(const void **xpp, size_t nelems, uchar* tp);
extern int ncx_getn_uint_uint(const void **xpp, size_t nelems, uint* tp);
extern int ncx_getn_uint_ulonglong(const void **xpp, size_t nelems, ulonglong* tp);
extern int ncx_getn_uint_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_getn_ulonglong_double(const void **xpp, size_t nelems, double* tp);
extern int ncx_getn_ulonglong_float(const void **xpp, size_t nelems, float* tp);
extern int ncx_getn_ulonglong_int(const void **xpp, size_t nelems, int* tp);
extern int ncx_getn_ulonglong_longlong(const void **xpp, size_t nelems, longlong* tp);
extern int ncx_getn_ulonglong_schar(const void **xpp, size_t nelems, schar* tp);
extern int ncx_getn_ulonglong_short(const void **xpp, size_t nelems, short* tp);
extern int ncx_getn_ulonglong_uchar(const void **xpp, size_t nelems, uchar* tp);
extern int ncx_getn_ulonglong_uint(const void **xpp, size_t nelems, uint* tp);
extern int ncx_getn_ulonglong_ulonglong(const void **xpp, size_t nelems, ulonglong* tp);
extern int ncx_getn_ulonglong_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_getn_ushort_double(const void **xpp, size_t nelems, double* tp);
extern int ncx_getn_ushort_float(const void **xpp, size_t nelems, float* tp);
extern int ncx_getn_ushort_int(const void **xpp, size_t nelems, int* tp);
extern int ncx_getn_ushort_longlong(const void **xpp, size_t nelems, longlong* tp);
extern int ncx_getn_ushort_schar(const void **xpp, size_t nelems, schar* tp);
extern int ncx_getn_ushort_short(const void **xpp, size_t nelems, short* tp);
extern int ncx_getn_ushort_uchar(const void **xpp, size_t nelems, uchar* tp);
extern int ncx_getn_ushort_uint(const void **xpp, size_t nelems, uint* tp);
extern int ncx_getn_ushort_ulonglong(const void **xpp, size_t nelems, ulonglong* tp);
extern int ncx_getn_ushort_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_pad_getn_schar_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_pad_getn_short_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_pad_getn_uchar_double(const void **xpp, size_t nelems, double* tp);
extern int ncx_pad_getn_uchar_float(const void **xpp, size_t nelems, float* tp);
extern int ncx_pad_getn_uchar_int(const void **xpp, size_t nelems, int* tp);
extern int ncx_pad_getn_uchar_longlong(const void **xpp, size_t nelems, longlong* tp);
extern int ncx_pad_getn_uchar_schar(const void **xpp, size_t nelems, schar* tp);
extern int ncx_pad_getn_uchar_short(const void **xpp, size_t nelems, short* tp);
extern int ncx_pad_getn_uchar_uchar(const void **xpp, size_t nelems, uchar* tp);
extern int ncx_pad_getn_uchar_uint(const void **xpp, size_t nelems, uint* tp);
extern int ncx_pad_getn_uchar_ulonglong(const void **xpp, size_t nelems, ulonglong* tp);
extern int ncx_pad_getn_uchar_ushort(const void **xpp, size_t nelems, ushort* tp);
extern int ncx_pad_putn_schar_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_pad_putn_short_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_pad_putn_uchar_double(void **xpp, size_t nelems, const double* tp);
extern int ncx_pad_putn_uchar_float(void **xpp, size_t nelems, const float* tp);
extern int ncx_pad_putn_uchar_int(void **xpp, size_t nelems, const int* tp);
extern int ncx_pad_putn_uchar_longlong(void **xpp, size_t nelems, const longlong* tp);
extern int ncx_pad_putn_uchar_schar(void **xpp, size_t nelems, const schar* tp);
extern int ncx_pad_putn_uchar_short(void **xpp, size_t nelems, const short* tp);
extern int ncx_pad_putn_uchar_uchar(void **xpp, size_t nelems, const uchar* tp);
extern int ncx_pad_putn_uchar_uint(void **xpp, size_t nelems, const uint* tp);
extern int ncx_pad_putn_uchar_ulonglong(void **xpp, size_t nelems, const ulonglong* tp);
extern int ncx_pad_putn_uchar_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_put_longlong(void **xpp, size_t nelems, const longlong *tp);
extern int ncx_putn_double_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_putn_float_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_putn_int_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_putn_longlong_double(void **xpp, size_t nelems, const double* tp);
extern int ncx_putn_longlong_float(void **xpp, size_t nelems, const float* tp);
extern int ncx_putn_longlong_int(void **xpp, size_t nelems, const int* tp);
extern int ncx_putn_longlong_longlong(void **xpp, size_t nelems, const longlong* tp);
extern int ncx_putn_longlong_schar(void **xpp, size_t nelems, const schar* tp);
extern int ncx_putn_longlong_short(void **xpp, size_t nelems, const short* tp);
extern int ncx_putn_longlong_uchar(void **xpp, size_t nelems, const uchar* tp);
extern int ncx_putn_longlong_uint(void **xpp, size_t nelems, const uint* tp);
extern int ncx_putn_longlong_ulonglong(void **xpp, size_t nelems, const ulonglong* tp);
extern int ncx_putn_longlong_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_putn_uint_double(void **xpp, size_t nelems, const double* tp);
extern int ncx_putn_uint_float(void **xpp, size_t nelems, const float* tp);
extern int ncx_putn_uint_int(void **xpp, size_t nelems, const int* tp);
extern int ncx_putn_uint_longlong(void **xpp, size_t nelems, const longlong* tp);
extern int ncx_putn_uint_schar(void **xpp, size_t nelems, const schar* tp);
extern int ncx_putn_uint_short(void **xpp, size_t nelems, const short* tp);
extern int ncx_putn_uint_uchar(void **xpp, size_t nelems, const uchar* tp);
extern int ncx_putn_uint_uint(void **xpp, size_t nelems, const uint* tp);
extern int ncx_putn_uint_ulonglong(void **xpp, size_t nelems, const ulonglong* tp);
extern int ncx_putn_uint_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_putn_ulonglong_double(void **xpp, size_t nelems, const double* tp);
extern int ncx_putn_ulonglong_float(void **xpp, size_t nelems, const float* tp);
extern int ncx_putn_ulonglong_int(void **xpp, size_t nelems, const int* tp);
extern int ncx_putn_ulonglong_longlong(void **xpp, size_t nelems, const longlong* tp);
extern int ncx_putn_ulonglong_schar(void **xpp, size_t nelems, const schar* tp);
extern int ncx_putn_ulonglong_short(void **xpp, size_t nelems, const short* tp);
extern int ncx_putn_ulonglong_uchar(void **xpp, size_t nelems, const uchar* tp);
extern int ncx_putn_ulonglong_uint(void **xpp, size_t nelems, const uint* tp);
extern int ncx_putn_ulonglong_ulonglong(void **xpp, size_t nelems, const ulonglong* tp);
extern int ncx_putn_ulonglong_ushort(void **xpp, size_t nelems, const ushort* tp);
extern int ncx_putn_ushort_double(void **xpp, size_t nelems, const double* tp);
extern int ncx_putn_ushort_float(void **xpp, size_t nelems, const float* tp);
extern int ncx_putn_ushort_int(void **xpp, size_t nelems, const int* tp);
extern int ncx_putn_ushort_longlong(void **xpp, size_t nelems, const longlong* tp);
extern int ncx_putn_ushort_schar(void **xpp, size_t nelems, const schar* tp);
extern int ncx_putn_ushort_short(void **xpp, size_t nelems, const short* tp);
extern int ncx_putn_ushort_uchar(void **xpp, size_t nelems, const uchar* tp);
extern int ncx_putn_ushort_uint(void **xpp, size_t nelems, const uint* tp);
extern int ncx_putn_ushort_ulonglong(void **xpp, size_t nelems, const ulonglong* tp);
extern int ncx_putn_ushort_ushort(void **xpp, size_t nelems, const ushort* tp);
